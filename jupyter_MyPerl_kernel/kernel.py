...
##do_runcode
    def do_runcode(self,return_code,fil_ename,magics,code, silent, store_history=True,
        ...
        if len(switches)>0:
            ...
            perlcmd+=['--']
        p = self.mymagics.create_jupyter_subprocess(perlcmd+[fil_ename]+ magics['_st']['args'],cwd=None,shell=False,env=self.mymagics.addkey2dict(magics,'env'),magics=magics)
